...
class Administrator extends CI_Controller
{
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$upload_data['g'] = $this->upload->data();
			$this->upload->do_upload('h');
			$upload_data['h'] = $this->upload->data();
			$this->upload->do_upload('i');
			$upload_data['i'] = $this->upload->data();
			$this->upload->do_upload('j');
			$upload_data['j'] = $this->upload->data();
			$this->upload->do_upload('k');
			$upload_data['k'] = $this->upload->data();
			$this->upload->do_upload('l');
			$upload_data['l'] = $this->upload->data();
			$this->upload->do_upload('m');
			$upload_data['m'] = $this->upload->data();
			$this->upload->do_upload('n');
			$upload_data['n'] = $this->upload->data();
			$this->upload->do_upload('o');
			$upload_data['o'] = $this->upload->data();
			$this->upload->do_upload('p');
			$upload_data['p'] = $this->upload->data();

			if ($upload_data['j']['file_name'] == $upload_data['i']['file_name']) {
				$data = array(
					...
					'gambar' => $upload_data['g']['file_name'],
					'gambar_2' => $upload_data['h']['file_name'],
					'gambar_3' => $upload_data['i']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
			} else if ($upload_data['k']['file_name'] == $upload_data['j']['file_name']) {
				$data = array(
					'id_kategori_produk' => $this->input->post('a'),
					...
					'gambar_2' => $upload_data['h']['file_name'],
					'gambar_3' => $upload_data['i']['file_name'],
					'gambar_4' => $upload_data['j']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
			} else if ($upload_data['l']['file_name'] == $upload_data['k']['file_name']) {
				$data = array(
					'id_kategori_produk' => $this->input->post('a'),
					'nama_produk' => $this->input->post('b'),
					'produk_seo' => $this->db->escape_str(seo_title($this->input->post('b'))),
					...
					'gambar_3' => $upload_data['i']['file_name'],
					'gambar_4' => $upload_data['j']['file_name'],
					'gambar_5' => $upload_data['k']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
			} else if ($upload_data['m']['file_name'] == $upload_data['l']['file_name']) {
				$data = array(
					'id_kategori_produk' => $this->input->post('a'),
					'nama_produk' => $this->input->post('b'),
					'produk_seo' => $this->db->escape_str(seo_title($this->input->post('b'))),
					...
					'gambar_4' => $upload_data['j']['file_name'],
					'gambar_5' => $upload_data['k']['file_name'],
					'gambar_6' => $upload_data['l']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
			} else if ($upload_data['n']['file_name'] == $upload_data['m']['file_name']) {
				$data = array(
					'id_kategori_produk' => $this->input->post('a'),
					'nama_produk' => $this->input->post('b'),
					'produk_seo' => $this->db->escape_str(seo_title($this->input->post('b'))),
					...
					'gambar_5' => $upload_data['k']['file_name'],
					'gambar_6' => $upload_data['l']['file_name'],
					'gambar_7' => $upload_data['m']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
			} else if ($upload_data['o']['file_name'] == $upload_data['n']['file_name']) {
				$data = array(
					'id_kategori_produk' => $this->input->post('a'),
					'nama_produk' => $this->input->post('b'),
					'produk_seo' => $this->db->escape_str(seo_title($this->input->post('b'))),
					...
					'gambar_6' => $upload_data['l']['file_name'],
					'gambar_7' => $upload_data['m']['file_name'],
					'gambar_8' => $upload_data['n']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
			} else if ($upload_data['p']['file_name'] == $upload_data['o']['file_name']) {
				$data = array(
					'id_kategori_produk' => $this->input->post('a'),
					'nama_produk' => $this->input->post('b'),
					'produk_seo' => $this->db->escape_str(seo_title($this->input->post('b'))),
					...
					'gambar_7' => $upload_data['m']['file_name'],
					'gambar_8' => $upload_data['n']['file_name'],
					'gambar_9' => $upload_data['o']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
				...
				$data = array(
					...
					'gambar_8' => $upload_data['n']['file_name'],
					'gambar_9' => $upload_data['o']['file_name'],
					'gambar_10' => $upload_data['p']['file_name'],
					'keterangan' => $this->input->post('ff'),
					'username' => $this->session->username,
					'waktu_input' => date('Y-m-d H:i:s')
				);
	...
	function konfirmasi_reseller()
	{
		cek_session_akses('konsumen', $this->session->id_session);
		$data['title'] = 'Laporan Pesanan Masuk';
		$data['record'] = $this->model_app->konfirm_reseller();
		$this->template->load('administrator/template', 'administrator/mod_reseller/view_konfirmasi_reseller', $data);
	}
	...
	function reseller_status()
	{
		...
		// $this->model_app->update('reseller_akun', $data, $where);
		$this->load->database();
		$this->db->update('reseller_akun', $data, $where);
		redirect('administrator/konfirmasi_reseller');
	}

	function produk_status()
	{
		$data = array('status_sale' => $this->uri->segment(4));
		$where = array('id_produk' => $this->uri->segment(3));
		$this->load->database();
		$this->db->update('rb_produk', $data, $where);
		redirect('administrator/produk');
	}
