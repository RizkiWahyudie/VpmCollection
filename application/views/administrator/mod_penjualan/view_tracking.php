<div class='col-md-12'>
  <div class='box box-info'>
    ...
    <div class='col-md-5'>
        <center>
        Total Tagihan 
        <h4 style='margin:0px;'>Rp " . rupiah($total['total'] + $total['ongkir'] - $total['potongan_transaksi']) . "<br> <br> 
      ...
      <table class='table table-striped table-condensed '>
        ...
        if ($total['potongan_transaksi'] == 0) {
          ...
          echo "
                <tr class='success'>
                  <td colspan='5'><b>Diskon 10% dari Total Item</b> <i style='float:right'>(" . terbilang($total['potongan_transaksi']) . ")</i></td>
          ...
          foreach ($konfirmasi as $r) {
            echo "<div class='col-md-8'>
                  <dl class='dl-horizontal'>
                      ...
                      <dt>Bukti Transfer</dt>      <dd><a href='" . base_url() . "asset/bukti_transfer/$r[bukti_transfer]'><img width='250px' src='" . base_url() . "asset/bukti_transfer/$r[bukti_transfer]' /></a></dd>
