<div class='col-md-12'>
  <div class='box box-info'>
    <div class='box-header with-border'>
      ...
      <a target='_BLANK' class='pull-right btn btn-warning btn-sm'
        href='<?php echo base_url(); ?>administrator/print_orders'>Print Report</a>
    </div>
    <div class='box-body'>
      <div class='col-md-12'>
          ...
          <tbody>
            ...
            foreach ($record->result_array() as $row) {
              ...
              echo "<tr><td>$no</td>
                                            ...
                                            <td style='color:red;'>Rp " . rupiah($total['total'] + $total['ongkir'] - $total['potongan_transaksi']) . "</td>
                                              ...
                                              <div class='btn-group'> 
                                                ...
                                                <button type='button' class='btn btn-$color btn-xs dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'> <span class='caret'></span> <span class='sr-only'>Toggle Dropdown</span> </button> 
                                                  <ul class='dropdown-menu' style='border:1px solid #cecece;'> 
                                                    ...
                                                    <li><a href='" . base_url() . "administrator/orders_status/$row[id_penjualan]/4' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi Diantar ?')\"> Diantar Kurir</a></li> 
                                                    <li><a href='" . base_url() . "administrator/orders_status/$row[id_penjualan]/5' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi Sampai Tujuan ?')\"> Sampai Tujuan</a></li> 
                                                    </ul> 
                                              </div>
