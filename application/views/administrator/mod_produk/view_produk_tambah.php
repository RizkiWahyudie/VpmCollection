...
echo "</td></tr>
                    ...
                    <tr><th scope='row'>Gambar</th>                     <td><input type='file' class='form-control' name='g' required></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='h' required></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='i' required></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='j'></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='k'></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='l'></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='m'></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='n'></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='o'></td></tr>
                    <tr><th scope='row'></th><td><input type='file' class='form-control' name='p'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
