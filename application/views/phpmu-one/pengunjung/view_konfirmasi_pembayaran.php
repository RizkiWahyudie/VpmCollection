<p class='titleProductWishlist'>Konfirmasi Pembayaran</p>
...
if ($rows['kode_transaksi'] != '') {
  echo "<tr><th scope='row'>Total</th>                  <td><input type='text' name='b' class='form-control' style='width:50%' value='Rp " . rupiah($total_transaksi) . "' required>
